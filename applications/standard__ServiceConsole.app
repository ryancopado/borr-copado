...
<CustomApplication xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <workspaceConfig>
        ...
        <mappings>
            <tab>Interconnection_Request__c</tab>
        </mappings>
        <mappings>
            <tab>Job_Levels__c</tab>
        </mappings>
        <mappings>
            <tab>Monthly_Ops_Metrics__c</tab>
        </mappings>
        <mappings>
            <tab>Non_Exempt_Time__c</tab>
        </mappings>
        <mappings>
            <tab>PO_Invoice__c</tab>
        </mappings>
        <mappings>
            <tab>PSD__c</tab>
        </mappings>
        <mappings>
            <tab>Performance_Data__c</tab>
        </mappings>
        <mappings>
            <tab>Performance_Guarantee__c</tab>
        </mappings>
        <mappings>
            <tab>Pricing_Tool_Approval__c</tab>
        </mappings>
        <mappings>
            <tab>Production_Modeling__c</tab>
        </mappings>
        <mappings>
            <tab>Project_Finance_Checklist__c</tab>
        </mappings>
        <mappings>
            <tab>Project_Products__c</tab>
        </mappings>
        <mappings>
