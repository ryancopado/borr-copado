...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    <alerts>
        <fullName>Shop_Drawing_1_Approved</fullName>
        <description>Shop Drawing 1 Approved</description>
        <protected>false</protected>
        <recipients>
            <type>creator</type>
        </recipients>
        <senderType>CurrentUser</senderType>
        <template>Alerts/Shop_Drawing_1_Approved</template>
    </alerts>
    <alerts>
        <fullName>Shop_Drawing_1_Rejected</fullName>
        <description>Shop Drawing 1 Rejected</description>
        <protected>false</protected>
        <recipients>
            <type>creator</type>
        </recipients>
        <senderType>CurrentUser</senderType>
        <template>Alerts/Shop_Drawing_1_Rejected</template>
    </alerts>
    <fieldUpdates>
    ...
    <rules>
        ...
        <active>true</active>
        <criteriaItems>
            <field>Shop_Drawing_1__c.Status__c</field>
